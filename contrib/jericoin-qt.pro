...
RESOURCES += src/qt/jericoin.qrc src/qt/jericoin_locale.qrc

TRANSLATIONS += src/qt/locale/jericoin_bg.ts \
                src/qt/locale/jericoin_de.ts \
                src/qt/locale/jericoin_en.ts \
                src/qt/locale/jericoin_es.ts \
                src/qt/locale/jericoin_fi.ts \
                src/qt/locale/jericoin_fr.ts \
                src/qt/locale/jericoin_it.ts \
                src/qt/locale/jericoin_ja.ts \
                src/qt/locale/jericoin_pl.ts \
                src/qt/locale/jericoin_pt.ts \
                src/qt/locale/jericoin_ru.ts \
                src/qt/locale/jericoin_sk.ts \
                src/qt/locale/jericoin_sv.ts \
                src/qt/locale/jericoin_vi.ts \
                src/qt/locale/jericoin_zh_CN.ts \
                src/qt/locale/jericoin_zh_TW.ts
