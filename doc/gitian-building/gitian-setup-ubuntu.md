...
The build script we'll be using is contained in the Jericoin github repository ([contrib/gitian-build.py](https://https://github.com/jericoin/JHL/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Jericoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/jericoin-bonte/Jericoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, jericoin-detached-sigs, and jericoin GitHub repos.
