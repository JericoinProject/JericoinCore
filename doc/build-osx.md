...
1. Clone the Jericoin source code:
...
Jericoin is now available at `./src/jericoind`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/jericoin"

    touch "/Users/${USER}/Library/Application Support/jericoin/jericoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/jericoin/jericoin.conf"

The first time you run jericoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/jericoin/debug.log

Other commands:
-------

    ./src/jericoind -daemon # Starts The Jericoin daemon.
    ./src/jericoin-cli --help # Outputs a list of command-line options.
    ./src/jericoin-cli help # Outputs a list of RPC commands when the daemon is running.
