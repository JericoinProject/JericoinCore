...
// Copyright (c) 2015-2019 The Jericoin developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000ab5264e5fe97731218b92f0a0941970ed4271d1fcd609506a4e0a02d134"))
    (1, uint256("0x000000722b5c2355b555c681ede23ccf1dd4451cbdf17cc1d0f0d435a40e0e54"))
    (16, uint256("0x000007315bb1fe29ecce21e6e0764e3e92c2fb0b0043367db80e36ef7351e568"))
    (31, uint256("0x00000e19260900cf59d47cc04bf669a5aa40aec71fa68fd29077514dcaf4dfff"))
    (100, uint256("0x0000001860c0fcab47a4ec53898fc2874eefe0c3432a939a3d6179abf0eb8b66"))
    (498, uint256("0x000000015c9c82962ad1f7266de7d63e5dc76c5c4c000cc4a2afb82b3ff9b033"))
    (600, uint256("0x00000002082ce8e34911c76124f33e2c961359801a7e77f707577e3692aee5b5"))
    (606, uint256("0x000000006f983e414ab2ca5ad30c8bad0db0b6239fef14a6b896a33b915f6c8f"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1671894442, // * UNIX timestamp of last checkpoint block
    619,          // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("046c161adb95c9cee8db8b2268b9f8bab0d4a12c8b93fb72a1a6b68b101a8a885d56aaf104919e6d117802d40b193316136be305b8917762421895d4d420e8f9a0");
        nDefaultPort = 31357;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Jericoin starting difficulty is 1 / 2^12
        ...
        nTargetTimespan = 20 * 60;                      // 2 minutes
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Keep on hearing, but do not understand; keep on seeing, but do not perceive. IS6-9";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << std::vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 7 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("048866b606c3d6b99c1133cb60d9bf449e74a72b1d7372deb9939a1510fbdf3fe524d1185783c00052b78dd9ab829775d28b4d1728d8f6112d0e05a1382c2cce99") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = BlockMerkleRoot(genesis);
        genesis.nVersion = 1;
        genesis.nTime = 1671840833;
        genesis.nBits = 0x1e0fffff;
        genesis.nNonce = 21138591;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000ab5264e5fe97731218b92f0a0941970ed4271d1fcd609506a4e0a02d134"));
        assert(genesis.hashMerkleRoot == uint256("0x346bbcad4a0ee00987b42f1f6b4505415ab91cc82cca4bd4b1b179811f5c5506"));
	...
	vSeeds.push_back(CDNSSeedData("198.23.60.195", "198.23.60.195"));    // Primery DNS Seeder 
        ...
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 105); // 
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 171); // 
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x02)(0x2D)(0x25)(0x33).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x02)(0x21)(0x31)(0x2B).convert_to_container<std::vector<unsigned char> >();
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80000277).convert_to_container<std::vector<unsigned char> >(); 
        ...
        strSporkPubKey = "04ae0d46ed5f530de5525bfcacb40e88a090f8268659121b96f6fa920d21b4c958daa67ac4b70c12188884043dfc0307f3f90982aeb9af2d2a66b8c78e99e3af95";
        strObfuscationPoolDummyAddress = "";
        nStartMasternodePayments = 1671840833;
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("049f2579c0792f342a7814aa7d9adfd91f137c1f2ef41e0139c55a2473ee06f133fa59e291ceaf87e004c698f76667a4532a31ed214cc78e1fbf246b3f737b6b9d");
        nDefaultPort = 32357;
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nJericoinBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nJericoinBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 40); // Testnet jericoin addresses start with 'H'
	base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 41);  // 
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 100);  // 'h'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 168);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet jericoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet jericoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet jericoin BIP44 coin type is '1' (All coin's testnet default)
        ...
        strSporkPubKey = "045b21d562cef4c12ec3c248e7976111212a644ebc308d7109847b8ca6a4bd3087bf7daeb45f328d983d47197168fcde90487534e27b4c71e5d9cfd30c865485be";
        strObfuscationPoolDummyAddress = "";
        nStartMasternodePayments = 1671840833;
