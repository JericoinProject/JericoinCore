...
#include "qt/jericoin/forms/ui_receivewidget.h"
...
#include "qt/jericoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(JericoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive JHL."));
