...
#include "qt/jericoin/forms/ui_addresseswidget.h"
#include "qt/jericoin/addresslabelrow.h"
#include "qt/jericoin/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(JericoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter Jericoin address"));
