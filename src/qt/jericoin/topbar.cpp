...
#include "qt/jericoin/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/jericoin/lockunlock.h"
#include "qt/jericoin/qtutils.h"
#include "qt/jericoin/receivedialog.h"
...
TopBar::TopBar(JericoinGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("Jericoin")
    updateDisplayUnit();
