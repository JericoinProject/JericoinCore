...
#include "qt/jericoin/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(JericoinGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-jericoin");
