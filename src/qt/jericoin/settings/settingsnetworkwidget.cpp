...
#include "qt/jericoin/settings/settingsnetworkwidget.h"
#include "qt/jericoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/jericoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(JericoinGUI* _window, QWidget *parent) :
