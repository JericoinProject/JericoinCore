...
#include "qt/jericoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/jericoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(JericoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to JericoinGUI::handleRestart()
