...
#include "qt/jericoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(JericoinGUI* _window, QWidget *parent) :
