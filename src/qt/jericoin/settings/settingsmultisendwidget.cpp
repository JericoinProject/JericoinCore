...
#include "qt/jericoin/settings/forms/ui_settingsmultisendwidget.h"
#include "qt/jericoin/settings/settingsmultisenddialog.h"
    ...
    ui(new Ui::SettingsMultisendWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other Jericoin addresses after it matures."));
