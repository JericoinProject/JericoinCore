...
#include "qt/jericoin/settings/forms/ui_settingsmainoptionswidget.h"
#include "QListView"
...
SettingsMainOptionsWidget::SettingsMainOptionsWidget(JericoinGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsMainOptionsWidget)
{
    ...
    // Switch
    ui->pushSwitchStart->setText(tr("Start Jericoin on system login"));
