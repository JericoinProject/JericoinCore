...
#include "qt/jericoin/coincontrolpivwidget.h"
#include "qt/jericoin/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select JHL Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("JHL");
    ...
    ui->labelValueAfter->setText("0.00 JHL");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 JHL");
    ui->labelValueFee->setText("0.00 JHL");
