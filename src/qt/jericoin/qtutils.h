...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, JericoinGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, JericoinGUI *gui, double posX = 3);
