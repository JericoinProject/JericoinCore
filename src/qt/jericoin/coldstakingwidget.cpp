...
#include "qt/jericoin/coldstakingwidget.h"
#include "qt/jericoin/forms/ui_coldstakingwidget.h"
#include "qt/jericoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/jericoin/requestdialog.h"
#include "qt/jericoin/tooltipmenu.h"
#include "qt/jericoin/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(JericoinGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your JHLs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept JHL delegation / Delegate JHL"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select JHL outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 JHL" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
