...
#include "qt/jericoin/furabstractlistitemdelegate.h"
#include "qt/jericoin/txviewholder.h"
#include "qt/jericoin/tooltipmenu.h"
#include "qt/jericoin/sendmultirow.h"
#include "qt/jericoin/coldstakingmodel.h"
#include "qt/jericoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(JericoinGUI* parent);
    ~ColdStakingWidget();
