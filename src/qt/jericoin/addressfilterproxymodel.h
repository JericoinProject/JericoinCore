...
#ifndef Jericoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Jericoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Jericoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
