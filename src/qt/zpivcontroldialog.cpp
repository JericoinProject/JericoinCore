// Copyright (c) 2017-2020 The Jericoin developers
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zJHL Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zJHL.";
            else if (!mint.isSeedCorrect)
                strReason = "The zJHL seed used to mint this zJHL is not the same as currently hold in the wallet";
            else
