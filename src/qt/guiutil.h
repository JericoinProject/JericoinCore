...
/** Utility functions used by the Jericoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Jericoin addresses in monospace font
...
// Parse "jericoin:" URI into recipient object, return true on successful parsing
