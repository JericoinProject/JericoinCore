...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Jericoin Core jericoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  jericoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jericoin transaction") + "\n" +
                               "  jericoin-tx [options] -create [commands]   " + _("Create hex-encoded jericoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded jericoin transaction
