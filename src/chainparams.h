 ...
 * Jericoin system. There are three: the main network on which people trade goods
...
public:
    ...
    int JericoinBadBlockTime() const { return nJericoinBadBlockTime; }
    int JericoinBadBlocknBits() const { return nJericoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nJericoinBadBlockTime;
    unsigned int nJericoinBadBlocknBits;
