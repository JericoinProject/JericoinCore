// Copyright (c) 2017-2018 The Jericoin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef Jericoin_ZJHLWALLET_H
#define Jericoin_ZJHLWALLET_H
...
public:
    CzJHLWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZJHL(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZJHL(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
