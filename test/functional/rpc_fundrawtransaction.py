...
class RawTransactionsTest(JericoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid jericoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid jericoin address" in e.error['message'])
